...
router.get('/keys',
  ...
  externalApiController.getApiKeys
);
...
router.post('/keys',
  authMiddleware.authenticate,
  externalApiController.createApiKey
);
...
router.delete('/keys/:id',
  authMiddleware.authenticate,
  externalApiController.revokeApiKey
);
...
router.get('/hook',
  authMiddleware.authenticate,
  externalApiController.getWebhooks
);
...
router.post('/hook',
  authMiddleware.authenticate,
  externalApiController.registerWebhook
);
...
router.put('/hook/:id',
  authMiddleware.authenticate,
  externalApiController.updateWebhook
);
 ...
 *         $ref: '#/components/responses/NotFoundError'
 */
router.delete('/hook/:id',
  authMiddleware.authenticate,
  externalApiController.deleteWebhook
);
...
router.get('/events',
  authMiddleware.authenticate,
  externalApiController.getEventTypes
);
...
router.post('/trigger',
  authMiddleware.authenticate,
  externalApiController.triggerTestEvent
);
 ...
 */
router.get('/verify',
  externalApiController.verifyApiKey
);

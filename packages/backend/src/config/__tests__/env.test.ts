import { env, validateEnv, EnvSchema } from '../env';
...
describe('Environment Configuration', () => {
  ...
  it('should use default values when environment variables are not set', () => {
    ...
    expect(freshEnv.STORAGE_PATH).toBe(path.resolve(process.cwd(), 'storage'));
    ...
    expect(freshEnv.LOG_FILE).toBe(path.resolve(process.cwd(), 'logs/app.log'));
  });
